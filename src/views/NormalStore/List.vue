...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: '所在仓库', value: 'warehouseNumber' },
  ...
  methods: {
    ...
    async searchStore() {
      if (this.$refs.form.validate()) {
        this.storeData = await normalStore.findByContract(this.search.selectedContract.id)
      }
    },
