<template>
  <v-row dense>
    ...
    <v-col :cols="col">
      <v-text-field label="上货货架码" v-model="carryInInfo.shelfCode" hide-details readonly></v-text-field>
    </v-col>
    <v-col :cols="col">
    ...
    <v-col :cols="col">
      <v-text-field
        label="货品类别"
        :value="`${carryInInfo.categoryNumber} - ${carryInInfo.categoryName}`"
        hide-details
        readonly
      ></v-text-field>
    </v-col>
